...
export function downloadVCard(): void {
  const vcardContent = [
    ...
    'TITLE:Montagem e Manutenção de Celulares e Tablets',
    ...
    'NOTE:Hi-Tech Eletrônicos - Montagem e Manutenção de Celulares e Tablets. Tel: (22) 99870-6841. Endereço: Av. Jane Maria Martins Figueira, 12 - Jardim Marileia, Rio das Ostras - RJ. Horário: Seg a Sex 09:00-18:30 | Sáb 09:00-14:30.',
    'END:VCARD'
  ].join('\r\n');
